...
class StudentsAdapter(
    ...
    class MyViewHolder(itemView: View, private val onItemClicked: (position: Int) -> Unit) :
        ...
        val textViewStudentId: TextView = itemView.findViewById(R.id.student_list_item_id)
        val textViewStudentName: TextView = itemView.findViewById(R.id.student_list_item_name)
